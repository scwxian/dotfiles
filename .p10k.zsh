# Generated by Powerlevel10k configuration wizard on 2025-07-18 at 15:24 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%0F╰─ %2F❯'
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a, %d/%m - %H:%M:%S}'
  ...
  typeset -g POWERLEVEL9K_TIME_LEFT_RIGHT_WHITESPACE=' %k%4F󰶻'
